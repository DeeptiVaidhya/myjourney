...
@Component({
	selector: 'app-prevent-second-cancer',
	templateUrl: './prevent-second-cancer.component.html',
	styleUrls: ['./prevent-second-cancer.component.css'],
})
export class PreventSecondCancerComponent implements OnInit {
	breadcrumb = [
		...
		{ title: 'Ways to prevent second cancers', class: 'active' },
	];
