...
const MAINMENU_ROUTES: Routes = [
	...
	{ path: 'patient/dashboard', component: DashboardComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/understanding-breast-cancer', component: UnderstandingBreastCancerComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/understanding-breast-cancer/breast-cancer/what-is-breast-cancer', component: WhatIsBreastCancerComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/understanding-breast-cancer/breast-cancer/who-gets-breast-cancer', component: WhoGetsBreastCancerComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/understanding-breast-cancer/breast-cancer/what-does-not-cause-breast-cancer', component: WhatDoesnotCauseBreastCancerComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/understanding-breast-cancer/breast-cancer/breast-cancer-treatment', component: BreastCancerTreatmentComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/understanding-breast-cancer/breast-cancer/who-treats-breast-cancer', component: WhoTreatsBreastCancerComponent, canActivate: [PatientGuard] },

	{ path: 'patient/dashboard/understanding-breast-cancer/wellness/second-cancer', component: SecondCancerComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/understanding-breast-cancer/wellness/breast-cancer-screening', component: BreastCancerScreeningComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/understanding-breast-cancer/wellness/cervical-cancer-screening', component: CervicalCancerScreeningComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/understanding-breast-cancer/wellness/colorectal-cancer-screening', component: ColorectalCancerScreeningComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/understanding-breast-cancer/wellness/lung-cancer-screening', component: LungCancerScreeningComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/understanding-breast-cancer/wellness/skin-cancer-screening', component: SkinCancerScreeningComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/understanding-breast-cancer/wellness/prevent-second-cancer', component: PreventSecondCancerComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/understanding-breast-cancer/wellness/sun-protection', component: SunProtectionComponent, canActivate: [PatientGuard] },




	{ path: 'patient/dashboard/eat-well-feel-well', component: EatWellFeelWellComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/healthy-mind', component: HealthyMindComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/healthy-at-any-age', component: HealthyAtAnyAgeComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/staying-active', component: StayingActiveComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/care-after-cancer', component: CareAfterCancerComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/life-after-cancer', component: LifeAfterCancerComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/wrapping-up', component: WrappingUpComponent, canActivate: [PatientGuard] },
	...
	// Questionnaire
	{ path: 'patient/dashboard/pro-ctcae', component: ProCtcaeComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/promis', component: PromisComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/fact-g7', component: FactG7Component, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/decision-making', component: DecisionMakingComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/ies', component: IesComponent, canActivate: [PatientGuard] },
	{ path: 'patient/dashboard/report', component: ReportComponent, canActivate: [PatientGuard] },
	{ path: 'patient/profile', component: ProfileComponent, canActivate: [PatientGuard] },

	// Researcher Routes
	{ path: 'researcher/dashboard', component: ResearcherDashboardComponent, canActivate: [ResearcherGuard] },
	{ path: 'researcher/profile', component: ResearcherProfileComponent, canActivate: [ResearcherGuard] },
	{ path: 'researcher/add-patient', component: AddPatientComponent, canActivate: [ResearcherGuard] },
	{ path: 'researcher/patients', component: ListPatientsComponent, canActivate: [ResearcherGuard] },
	{ path: 'researcher/patient-details/:user_id', component: PatientDetailsComponent, canActivate: [ResearcherGuard] },
	{ path: 'researcher/add-provider', component: AddProviderComponent, canActivate: [ResearcherGuard] },
	{ path: 'researcher/providers', component: ListProvidersComponent, canActivate: [ResearcherGuard] },
	{ path: 'researcher/edit-patient/:user_id', component: EditPatientComponent, canActivate: [ResearcherGuard] },
	{ path: 'researcher/patient-report/:user_id', component: ReportComponent, canActivate: [ResearcherGuard] },



	// Provider Routes
	{ path: 'provider/dashboard', component: ResearcherDashboardComponent, canActivate: [ProviderGuard] },
	{ path: 'provider/profile', component: ResearcherProfileComponent, canActivate: [ProviderGuard] },
	{ path: 'provider/patients', component: ListPatientsComponent, canActivate: [ProviderGuard] },
	{ path: 'provider/patient-details/:user_id', component: PatientDetailsComponent, canActivate: [ProviderGuard] },
	{ path: 'provider/patient-report/:user_id', component: ReportComponent, canActivate: [ProviderGuard] },
// Common Routes
